...
<body>
   ...
   @endif
						...
						<div class="field-group editContent">
							...
							<div class="wthree-field">
								<input name="semster" id="semster" type="semster" value="" placeholder="Your Semster" @error('semster') is-invalid @enderror" name="semster" value="{{ old('semster') }}" required autocomplete="semster" />
							</div>
						     @error('semster')
                             <span class="invalid-feedback" role="alert">
                             <strong>{{ $message }}</strong>
