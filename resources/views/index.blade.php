			...
			<div class="row">
				...
				<div class="col-md-8">
					<nav id="nav" class="main-navigation hidden-xs hidden-sm">
						<ul class="main-menu">
							<li><a class="show-1 active homebutton" href="/home">Home</a></li>
							<li><a class="show-2 aboutbutton" href="/about">About Us</a></li>
					...
					<div class="offer-holder">
						<div class="col-md-6">
							<div class="offer-item offer-1 animated fadeInLeft">
								<figure>
									<img src="{{ asset('NewTemplate') }}/img/a1.jpg" alt="">
								</figure>
						...
						<div class="col-md-6">
							<div class="offer-item offer-2 animated fadeInRight">
								<figure>
									<img src="{{ asset('NewTemplate') }}/img/a2.jpg" alt="">
								</figure>
								<div class="offer-content text-center">
			...
			<div class="projects-holder">
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 p-3 animated umScaleIn">
						<div class="project-item">
							<img src="{{ asset('NewTemplate') }}/img/3.jpg" alt="">
							<div class="overlay">
								<h4><a href="#">Project Three</a></h4>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						<div class="project-item p-5 animated umScaleIn">
							<img src="{{ asset('NewTemplate') }}/img/5.jpg" alt="">
							<div class="overlay">
